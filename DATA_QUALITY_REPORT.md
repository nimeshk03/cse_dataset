...
Generated: 2026-09-01T22:35:26Z

## Summary

| Metric | Value |
|---|---|
| Total rows | 1,260,408 |
| Symbols | 300 |
| Date range | 2010-01-01 to 2026-09-01 |
| Columns | 46 |
| Duplicate `(symbol, date)` rows | 0 |
| OHLC-invalid rows | 0 (0.00%) |
| Source OHLC-invalid rows | 40,503 |
| OHLC-repaired rows | 40,503 |
...
|---|---|---|
| `policy_rate` | 1,260,408 | 100.0% |
| `vader_score_mean` | 1,260,408 | 100.0% |
| `vader_score_max` | 1,260,408 | 100.0% |
| `vader_label` | 1,260,408 | 100.0% |
| `finbert_label` | 1,260,408 | 100.0% |
| `tbill_6m` | 1,260,408 | 100.0% |
| `tbill_3m` | 1,260,408 | 100.0% |
| `tbill_12m` | 1,260,408 | 100.0% |
| `market_vader_mean` | 1,082,532 | 85.89% |
| `market_news_count` | 1,082,532 | 85.89% |
| `usd_lkr` | 125,928 | 9.99% |
| `sp500` | 36,010 | 2.86% |
| `inflation_pct` | 36,010 | 2.86% |
| `nikkei225` | 36,010 | 2.86% |
| `gdp_growth_pct` | 36,010 | 2.86% |
| `hangseng` | 36,010 | 2.86% |
| `close_to_ma200` | 29,259 | 2.32% |
...
| CHL.N0000 | 2026-03-02 | 2026-09-01 | 132 |
| CHL.X0000 | 2026-03-02 | 2026-09-01 | 129 |
| CINS.N0000 | 2026-03-02 | 2026-09-01 | 111 |
| HNBF.R0000 | 2026-06-10 | 2026-06-18 | 7 |
| HNBF.R0001 | 2026-06-10 | 2026-06-18 | 7 |
| JXG.N0000 | 2026-03-02 | 2026-09-01 | 132 |
| MBSL.R0001 | 2026-07-21 | 2026-07-29 | 7 |
| NAMU.N0000 | 2026-03-02 | 2026-09-01 | 130 |
| SING.N0000 | 2026-07-23 | 2026-09-01 | 27 |
