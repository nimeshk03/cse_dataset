...
Generated: 2026-07-20T21:21:15Z

## Summary

| Metric | Value |
|---|---|
| Total rows | 1,251,953 |
| Symbols | 297 |
| Date range | 2010-01-01 to 2026-07-20 |
| Columns | 46 |
| Duplicate `(symbol, date)` rows | 0 |
| OHLC-invalid rows | 0 (0.00%) |
| Source OHLC-invalid rows | 39,614 |
| OHLC-repaired rows | 39,614 |
...
| Rows with market sentiment | 176,933 |
...
|---|---|---|
| `policy_rate` | 1,251,953 | 100.0% |
| `vader_score_mean` | 1,251,953 | 100.0% |
| `vader_score_max` | 1,251,953 | 100.0% |
| `vader_label` | 1,251,953 | 100.0% |
| `finbert_label` | 1,251,953 | 100.0% |
| `tbill_6m` | 1,251,953 | 100.0% |
| `tbill_3m` | 1,251,953 | 100.0% |
| `tbill_12m` | 1,251,953 | 100.0% |
| `market_vader_mean` | 1,075,020 | 85.87% |
| `market_news_count` | 1,075,020 | 85.87% |
| `usd_lkr` | 117,473 | 9.38% |
| `close_to_ma200` | 29,213 | 2.33% |
| `inflation_pct` | 27,555 | 2.2% |
| `sp500` | 27,555 | 2.2% |
| `gdp_growth_pct` | 27,555 | 2.2% |
| `nikkei225` | 27,555 | 2.2% |
| `hangseng` | 27,555 | 2.2% |
...
|---|---|---|---|
| CHL.N0000 | 2026-03-02 | 2026-07-20 | 101 |
| CHL.X0000 | 2026-03-02 | 2026-07-20 | 100 |
| CINS.N0000 | 2026-03-02 | 2026-07-20 | 93 |
| HNBF.R0000 | 2026-06-10 | 2026-06-18 | 7 |
| HNBF.R0001 | 2026-06-10 | 2026-06-18 | 7 |
| JXG.N0000 | 2026-03-02 | 2026-07-20 | 101 |
| NAMU.N0000 | 2026-03-02 | 2026-07-20 | 101 |
