...
| Metric | Value |
|---|---|
| Total rows | 1,232,790 |
| Symbols | 290 |
| Date range | 2010-01-01 to 2026-04-17 |
| Columns | 30 |
| Trading-day rows (volume > 0) | 1,232,790 (100.0%) |
| OHLC-invalid rows | 34,008 (2.76%) |
...
|---|---|---|
| `volume_zscore` | 1,232,790 | 100.0% |
| `finbert_label` | 1,232,790 | 100.0% |
| `vader_score_max` | 1,232,790 | 100.0% |
| `vader_score_mean` | 1,232,790 | 100.0% |
| `market_vader_mean` | 1,056,180 | 85.67% |
| `market_news_count` | 1,056,180 | 85.67% |
| `usd_lkr` | 98,310 | 7.97% |
| `close_to_ma200` | 28,710 | 2.33% |
| `inflation_pct` | 22,330 | 1.81% |
| `gdp_growth_pct` | 22,330 | 1.81% |
...
| Stat | Value |
|---|---|
| Mean trading days per symbol | 4251 |
| Median trading days per symbol | 4251 |
| Min trading days | 4251 |
| Max trading days | 4251 |
