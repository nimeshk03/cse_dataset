...
Generated: 2026-08-13T20:55:12Z

## Summary

| Metric | Value |
|---|---|
| Total rows | 1,257,029 |
| Symbols | 299 |
| Date range | 2010-01-01 to 2026-08-13 |
| Columns | 46 |
| Duplicate `(symbol, date)` rows | 0 |
| OHLC-invalid rows | 0 (0.00%) |
| Source OHLC-invalid rows | 39,962 |
| OHLC-repaired rows | 39,962 |
| `volume_zscore` null rate | 0.00% |
| Adjusted-close rows | 0 |
| Adjusted-close symbols | 0 |
| Dividend rows with amount | 0 / 1,718 |
...
| Rows with market sentiment | 177,369 |
...
|---|---|---|
| `policy_rate` | 1,257,029 | 100.0% |
| `vader_score_mean` | 1,257,029 | 100.0% |
| `vader_score_max` | 1,257,029 | 100.0% |
| `vader_label` | 1,257,029 | 100.0% |
| `finbert_label` | 1,257,029 | 100.0% |
| `tbill_6m` | 1,257,029 | 100.0% |
| `tbill_3m` | 1,257,029 | 100.0% |
| `tbill_12m` | 1,257,029 | 100.0% |
| `market_vader_mean` | 1,079,660 | 85.89% |
| `market_news_count` | 1,079,660 | 85.89% |
| `usd_lkr` | 122,549 | 9.75% |
| `sp500` | 32,631 | 2.6% |
| `inflation_pct` | 32,631 | 2.6% |
| `nikkei225` | 32,631 | 2.6% |
| `gdp_growth_pct` | 32,631 | 2.6% |
| `hangseng` | 32,631 | 2.6% |
| `close_to_ma200` | 29,241 | 2.33% |
| `close_to_ma50` | 7,116 | 0.57% |
| `return_20d` | 5,936 | 0.47% |
...
|---|---|---|---|
| CHL.N0000 | 2026-03-02 | 2026-08-13 | 119 |
| CHL.X0000 | 2026-03-02 | 2026-08-13 | 118 |
| CINS.N0000 | 2026-03-02 | 2026-08-13 | 101 |
| HNBF.R0000 | 2026-06-10 | 2026-06-18 | 7 |
| HNBF.R0001 | 2026-06-10 | 2026-06-18 | 7 |
| JXG.N0000 | 2026-03-02 | 2026-08-13 | 119 |
| MBSL.R0001 | 2026-07-21 | 2026-07-29 | 7 |
| NAMU.N0000 | 2026-03-02 | 2026-08-13 | 119 |
| SING.N0000 | 2026-07-23 | 2026-08-13 | 15 |
