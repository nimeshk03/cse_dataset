...
Generated: 2026-08-17T20:37:31Z

## Summary

| Metric | Value |
|---|---|
| Total rows | 1,257,596 |
| Symbols | 300 |
| Date range | 2010-01-01 to 2026-08-17 |
| Columns | 46 |
| Duplicate `(symbol, date)` rows | 0 |
| OHLC-invalid rows | 0 (0.00%) |
| Source OHLC-invalid rows | 39,999 |
| OHLC-repaired rows | 39,999 |
| `volume_zscore` null rate | 0.00% |
| Adjusted-close rows | 0 |
| Adjusted-close symbols | 0 |
| Dividend rows with amount | 0 / 1,720 |
...
| Rows with market sentiment | 177,646 |
...
|---|---|---|
| `policy_rate` | 1,257,596 | 100.0% |
| `vader_score_mean` | 1,257,596 | 100.0% |
| `vader_score_max` | 1,257,596 | 100.0% |
| `vader_label` | 1,257,596 | 100.0% |
| `finbert_label` | 1,257,596 | 100.0% |
| `tbill_6m` | 1,257,596 | 100.0% |
| `tbill_3m` | 1,257,596 | 100.0% |
| `tbill_12m` | 1,257,596 | 100.0% |
| `market_vader_mean` | 1,079,950 | 85.87% |
| `market_news_count` | 1,079,950 | 85.87% |
| `usd_lkr` | 123,116 | 9.79% |
| `sp500` | 33,198 | 2.64% |
| `inflation_pct` | 33,198 | 2.64% |
| `nikkei225` | 33,198 | 2.64% |
| `gdp_growth_pct` | 33,198 | 2.64% |
| `hangseng` | 33,198 | 2.64% |
| `close_to_ma200` | 29,245 | 2.33% |
| `close_to_ma50` | 7,120 | 0.57% |
| `return_20d` | 5,940 | 0.47% |
| `volatility_20d` | 2,983 | 0.24% |
| `return_5d` | 1,497 | 0.12% |
...
|---|---|---|---|
| AAF.R0000 | 2026-08-14 | 2026-08-17 | 2 |
| CHL.N0000 | 2026-03-02 | 2026-08-17 | 121 |
| CHL.X0000 | 2026-03-02 | 2026-08-17 | 120 |
| CINS.N0000 | 2026-03-02 | 2026-08-14 | 102 |
| HNBF.R0000 | 2026-06-10 | 2026-06-18 | 7 |
| HNBF.R0001 | 2026-06-10 | 2026-06-18 | 7 |
| JXG.N0000 | 2026-03-02 | 2026-08-17 | 121 |
| MBSL.R0001 | 2026-07-21 | 2026-07-29 | 7 |
| NAMU.N0000 | 2026-03-02 | 2026-08-17 | 121 |
| SING.N0000 | 2026-07-23 | 2026-08-17 | 17 |
