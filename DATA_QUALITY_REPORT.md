...
Generated: 2026-07-01T21:48:01Z

## Summary

| Metric | Value |
|---|---|
| Total rows | 1,248,262 |
| Symbols | 297 |
| Date range | 2010-01-01 to 2026-07-01 |
| Columns | 46 |
| Duplicate `(symbol, date)` rows | 0 |
| OHLC-invalid rows | 0 (0.00%) |
| Source OHLC-invalid rows | 39,356 |
| OHLC-repaired rows | 39,356 |
...
| Rows with market sentiment | 176,979 |
...
|---|---|---|
| `policy_rate` | 1,248,262 | 100.0% |
| `vader_score_mean` | 1,248,262 | 100.0% |
| `vader_score_max` | 1,248,262 | 100.0% |
| `vader_label` | 1,248,262 | 100.0% |
| `finbert_label` | 1,248,262 | 100.0% |
| `tbill_6m` | 1,248,262 | 100.0% |
| `tbill_3m` | 1,248,262 | 100.0% |
| `tbill_12m` | 1,248,262 | 100.0% |
| `market_vader_mean` | 1,071,283 | 85.82% |
| `market_news_count` | 1,071,283 | 85.82% |
| `usd_lkr` | 113,782 | 9.12% |
| `close_to_ma200` | 29,157 | 2.34% |
| `inflation_pct` | 23,864 | 1.91% |
| `sp500` | 23,864 | 1.91% |
| `gdp_growth_pct` | 23,864 | 1.91% |
| `nikkei225` | 23,864 | 1.91% |
| `hangseng` | 23,864 | 1.91% |
...
|---|---|---|---|
| CHL.N0000 | 2026-03-02 | 2026-07-01 | 88 |
| CHL.X0000 | 2026-03-02 | 2026-06-30 | 87 |
| CINS.N0000 | 2026-03-02 | 2026-07-01 | 82 |
| HNBF.R0000 | 2026-06-10 | 2026-06-18 | 7 |
| HNBF.R0001 | 2026-06-10 | 2026-06-18 | 7 |
| JXG.N0000 | 2026-03-02 | 2026-07-01 | 88 |
| NAMU.N0000 | 2026-03-02 | 2026-07-01 | 88 |
