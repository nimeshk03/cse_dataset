...
Generated: 2026-05-27T22:06:31Z

## Summary

| Metric | Value |
|---|---|
| Total rows | 1,241,091 |
| Symbols | 295 |
| Date range | 2010-01-01 to 2026-05-27 |
| Columns | 46 |
| Duplicate `(symbol, date)` rows | 0 |
| OHLC-invalid rows | 0 (0.00%) |
| Source OHLC-invalid rows | 38,950 |
| OHLC-repaired rows | 38,950 |
| `volume_zscore` null rate | 0.00% |
| Adjusted-close rows | 0 |
| Adjusted-close symbols | 0 |
| Dividend rows with amount | 0 / 1,663 |
...
| Rows with market sentiment | 178,791 |
...
|---|---|---|
| `policy_rate` | 1,241,091 | 100.0% |
| `vader_score_mean` | 1,241,091 | 100.0% |
| `vader_score_max` | 1,241,091 | 100.0% |
| `vader_label` | 1,241,091 | 100.0% |
| `finbert_label` | 1,241,091 | 100.0% |
| `tbill_6m` | 1,241,091 | 100.0% |
| `tbill_3m` | 1,241,091 | 100.0% |
| `tbill_12m` | 1,241,091 | 100.0% |
| `market_vader_mean` | 1,062,300 | 85.59% |
| `market_news_count` | 1,062,300 | 85.59% |
| `usd_lkr` | 106,611 | 8.59% |
| `gdp_growth_pct` | 30,631 | 2.47% |
| `inflation_pct` | 30,631 | 2.47% |
| `close_to_ma200` | 29,025 | 2.34% |
| `nikkei225` | 16,693 | 1.35% |
| `hangseng` | 16,693 | 1.35% |
| `sp500` | 16,693 | 1.35% |
...
|---|---|---|---|
| CHL.N0000 | 2026-03-02 | 2026-05-27 | 63 |
| CHL.X0000 | 2026-03-02 | 2026-05-27 | 63 |
| CINS.N0000 | 2026-03-02 | 2026-05-27 | 63 |
| JXG.N0000 | 2026-03-02 | 2026-05-27 | 63 |
| NAMU.N0000 | 2026-03-02 | 2026-05-27 | 63 |
