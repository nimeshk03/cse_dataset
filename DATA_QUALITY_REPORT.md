...
Generated: 2026-06-01T22:42:07Z

## Summary

| Metric | Value |
|---|---|
| Total rows | 1,241,956 |
| Symbols | 295 |
| Date range | 2010-01-01 to 2026-06-01 |
| Columns | 46 |
| Duplicate `(symbol, date)` rows | 0 |
| OHLC-invalid rows | 0 (0.00%) |
| Source OHLC-invalid rows | 38,992 |
| OHLC-repaired rows | 38,992 |
| `volume_zscore` null rate | 0.00% |
| Adjusted-close rows | 0 |
| Adjusted-close symbols | 0 |
| Dividend rows with amount | 0 / 1,672 |
...
|---|---|---|
| `policy_rate` | 1,241,956 | 100.0% |
| `vader_score_mean` | 1,241,956 | 100.0% |
| `vader_score_max` | 1,241,956 | 100.0% |
| `vader_label` | 1,241,956 | 100.0% |
| `finbert_label` | 1,241,956 | 100.0% |
| `tbill_6m` | 1,241,956 | 100.0% |
| `tbill_3m` | 1,241,956 | 100.0% |
| `tbill_12m` | 1,241,956 | 100.0% |
| `market_vader_mean` | 1,063,170 | 85.6% |
| `market_news_count` | 1,063,170 | 85.6% |
| `usd_lkr` | 107,476 | 8.65% |
| `gdp_growth_pct` | 31,496 | 2.54% |
| `inflation_pct` | 31,496 | 2.54% |
| `close_to_ma200` | 29,040 | 2.34% |
| `nikkei225` | 17,558 | 1.41% |
| `hangseng` | 17,558 | 1.41% |
| `sp500` | 17,558 | 1.41% |
...
|---|---|---|---|
| CHL.N0000 | 2026-03-02 | 2026-06-01 | 66 |
| CHL.X0000 | 2026-03-02 | 2026-06-01 | 66 |
| CINS.N0000 | 2026-03-02 | 2026-06-01 | 66 |
| JXG.N0000 | 2026-03-02 | 2026-06-01 | 66 |
| NAMU.N0000 | 2026-03-02 | 2026-06-01 | 66 |
